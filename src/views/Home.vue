      ...
      <div class="q-box--center">
         ...
         >
            ...
            <div class="flex justify-between">
               ...
               <Tooltip :offset="12" :placement="'top'" :text="'Follow Gary Simmons'">
                  <template v-slot:trigger>
                  <span class="trigger inline-flex w-6 h-6 bg-kora-gray1 rounded-full border-light-25 overflow-hidden items-center justify-center cursor-pointer hover:bg-opacity-50">
                     <Icon 
                        :class="'fill-current text-kora-dark2'" 
         ...
         <div class="discover mb-2 border-light-25 rounded">
            <div class="header p-4 flex items-center border-b border-kora-light1 border-opacity-10">
               ...
               <p class="ml-2 text-k-13 font-normal text-kora-light1 capitalize">discover new spaces</p>
            </div>
            <div 
